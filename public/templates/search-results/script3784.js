...
function searchResults() {
    ...
    // Selectors:
    const tripLinks = document.querySelectorAll("[repeater-trips] > a");
    ...
    tripLinks.forEach(function (trip) {
        let link = trip.getAttribute("href");
        let partialURL = link.replace("https://www.nathab.com", "");
        partialURL = link.replace("http://dev4.nathab.com", "");
        linksArray.push(partialURL);
    });
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    tripLinks.forEach(function (tripLink) {
                        ...
                        let notIncludedLink =
                            !linksArrayUpdated.includes(linkURL);
                    ...
                    const errorDates = document.querySelector(
                        ".js-search-error-date"
                    );
                    ...
                    const urlDiv = document.querySelector(
                        ".js-date-search-reset"
                    );
