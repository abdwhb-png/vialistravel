...
function backToTripBar() {
    ...
    function showBackToTripBar() {
        if (
            sessionStorage.getItem("backToTripURL") !== null &&
            sessionStorage.getItem("backToTripName") !== null
        ) {
            const backToTripURL = sessionStorage.getItem("backToTripURL");
            const backToTripName = sessionStorage.getItem("backToTripName");
            const backToTripElement =
                document.querySelector("[js-back-to-trip]");
    ...
    function backToCamp() {
        ...
        const campRepeaters = document.querySelectorAll(
            "[repeater~='trips'] a"
        );
        ...
        campRepeaters.forEach((camp) => {
            camp.addEventListener("click", function () {
                let activeSubnavLink = document.querySelector(
                    ".js-tripnav li.active a"
                );
