...
function trip360Footage() {
	const trip360URL = document.querySelector("[trip-360-url]").getAttribute("trip-360-url");
	const trip360Iframe = document.querySelector(".js-trip-360-url");

	if (trip360Iframe) {
		trip360Iframe.setAttribute("src", trip360URL);
	}
}
