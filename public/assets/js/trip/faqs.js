...
// Function: feature user to open/close all FAQ accordions
function openCloseFAQAccordions() {
    // Classes on _markup.kit (one group of accordions)
    const allFAQAccordions = document.querySelectorAll(".js-accordion");
    const openCloseFAQButton = document.querySelector(
        ".js-accordions-button-open"
    );

    // Function: open all accordions
    function openFAQAccordions() {
        allFAQAccordions.forEach(function (accordion) {
            accordion.checked = true;
            openCloseFAQButton.textContent = "Collapse All";
        });
    }

    // Function: close all accordions
    function closeFAQAccordions() {
        allFAQAccordions.forEach(function (accordion) {
            accordion.checked = false;
            openCloseFAQButton.textContent = "Expand All";
        });
    }

    // Event: listen for open/close button click
    openCloseFAQButton.addEventListener("click", function () {
        if (openCloseFAQButton.textContent.includes("Expand")) {
            openFAQAccordions();
        } else {
            closeFAQAccordions();
        }
