...
@section('content')
                ...
                <div class="nav-wrapper position-relative end-0">
                    <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                        ...
                        <div class="moving-tab position-absolute nav-link"
                            style="padding: 0px; transition: 0.5s; transform: translate3d(0px, 0px, 0px); width: 93px;"><a
                                class="nav-link mb-0 px-0 py-1 active " data-bs-toggle="tab" href="javascript:;"
    ...
    <div class="row">
        <div class="col-12 col-xl-4" id="site-brand">
            <div class="card h-100">
                <div class="card-header pb-0 p-3">
                    <h6 class="mb-0">Site Brand</h6>
                </div>
